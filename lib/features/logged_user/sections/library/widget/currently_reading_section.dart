...
class BooksCurrentlyReadingSection extends StatefulWidget {
  const BooksCurrentlyReadingSection({Key? key}) : super(key: key);

  @override
  State<BooksCurrentlyReadingSection> createState() => _ReadSectionState();
}

class _ReadSectionState extends State<BooksCurrentlyReadingSection> {
  @override
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              for (int i = 0; i < 4; i++)
                FutureBuilder(
                  future: BookSearchUtil.findBooks('se'),
